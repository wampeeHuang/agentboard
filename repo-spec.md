...
| [claude-skills](https://github.com/wampeeHuang/claude-skills) | 全部 39 个技能大包 | `~/.claude/skills/` |
| [evolution-cat-ai-article](https://github.com/wampeeHuang/evolution-cat-ai-article) | 进化猫文章 skill | `~/.claude/skills/evolution-cat-article/` |
| [evolution-cat-infographic](https://github.com/wampeeHuang/evolution-cat-infographic) | 小绿书图文 skill | `~/.claude/skills/evolution-cat-infographic/` |
| [skill-craftsmanship-framework](https://github.com/wampeeHuang/skill-craftsmanship-framework) | 工匠框架 skill | `~/.claude/skills/skill-craftsmanship-framework/` |
| [social-image-publisher](https://github.com/wampeeHuang/social-image-publisher) | 矩阵发布 skill | `~/.claude/skills/social-image-publisher/` |
