...
function createTool(body, dirs) {
  ...
  var knownFields = ['description', 'icon', 'version', 'category', 'order', 'port', 'ports', 'projectPath', 'url', 'startCommand', 'stopCommand', 'publicUrl', 'owner', 'apiBase', 'type', 'trigger', 'agent_notes', 'capability', 'dashboard'];
  knownFields.forEach(function (f) { if (body[f] !== undefined) mf[f] = body[f]; });
...
function updateTool(id, body, dirs) {
  ...
  var knownFields = ['name', 'description', 'icon', 'version', 'category', 'order', 'port', 'ports', 'projectPath', 'url', 'startCommand', 'stopCommand', 'publicUrl', 'owner', 'apiBase', 'type', 'trigger', 'agent_notes', 'conflicts', 'children', 'capability', 'dashboard'];
  var updated = {};
