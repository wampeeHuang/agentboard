...
module.exports = function (AGENTBOARD_HOME) {
  ...
  function buildRows() {
    ...
    reg.forEach(function (r) {
      var s = srcMap[r.name];
      var row = { name: r.name, category: r.category || '未分类', displayName: r.displayName || r.name, description: r.description || '', sourceDesc: s ? s.description : '', annotated: true, inSource: !!s };
